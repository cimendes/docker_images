...
You can download and run this image using the following commands:
    ...
    docker run --rm -u $(id -u):$(id -g) -it -v /local/folder/data:/data/ cimendes/midas:1.3.2-0.1 run_midas.py species /data/sample/ -d /NGStools/midas_db_v1.2 -1 /data/sample_1.fastq.gz -2 /data/sample_2.fastq.gz -t 2
